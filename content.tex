...
\paragraph{}
	...
	Tato činnost by nám jednak zabrala drahocenný čas který je potřeba na vývoj samotné aplikace.
	a také by v rámci této činnosti vycházely nové verze nebo i úplně nové enginy, což by znamenalo navracet se k nim a uvízli by jsme tak v cyklu bez jasné ukončovací podmínky.
	...
	i tak je to však množství které není možné zahrnout v jedné práci jejíž hlavní přínost není porovnávání herních enginů.
	Zaměříme se tedy poze na několik nejznámějších a nejpoužívanějších případů.
