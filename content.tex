...
\paragraph{}
	...
	Tento výrok je navíc spojený se smlouvou o fúzi s IronSource, společností zabývající se monetizací reklam a poskvrněnou minulostí InstallCore\cite{installCore_wiki}, jejich prvním produktem který bul klasifikován jako \textit{potencionálně nechtěný program}\cite{PUP_wiki}.
