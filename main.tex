...
\projectinfo{
  ...
  supervisor.name={Pepa},   % jméno školitele / supervisor name
  supervisor.surname={Novák},   % příjmení školitele / supervisor surname
  ...
  acknowledgment={
    Tímto bych chtěl poděkovat vedoucímu mé práce Ing. Pepovi Novákovi CSc. za odborné vedení
